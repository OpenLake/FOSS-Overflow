...
In this project, the app_usage flutter plugin is used to obtain app usage data. However, the data obtained with this plugin does not provide the second-to-second
data that was intended for the application. To enable this, we had to build our own plugin centered around the app_usage plugin, in order to make required changes.
